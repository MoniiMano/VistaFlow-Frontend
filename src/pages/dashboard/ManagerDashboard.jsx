...
import { MdFolder, MdTask, MdPeople, MdCheckCircle } from 'react-icons/md'
...
const ManagerDashboard = memo(() => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true)
        const response = await dashboardService.getManagerStats()
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <p style={{ color: textColor }}>Team statistics will be displayed here</p>
      </motion.div>
    </div>
  )
})
